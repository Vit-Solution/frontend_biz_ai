  ...
  useEffect(() => {
    ...
    if (questionParam) {
      ...
      const botResponse: Message = {
        id: "3",
        content: `Great question! Let me help you with "${decodeURIComponent(questionParam)}". Based on Nigerian business regulations, here's what you need to know: [This would be the actual response from your API]`,
        sender: "bot",
        timestamp: new Date()
      };
      ...
      demoMessages.push(
        ...
        {
          id: "3",
          content: "I'd be happy to help you with business registration! In Nigeria, you can register your business with the Corporate Affairs Commission (CAC). The main types are:\n\n1. **Business Name Registration** - For sole proprietorship\n2. **Company Registration** - For limited liability companies\n\nWhat type of business are you looking to register?",
          sender: "bot",
          timestamp: new Date()
        }
      );
    ...
    const demoChatSessions: ChatSession[] = [
      ...
      },
      {
        ...
        lastMessage: "You'll need to register for VAT if your annual turnover...",
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const botMessage: Message = {
        ...
        content: "Thank you for your question! I'm processing your request and will provide you with detailed information about Nigerian business requirements. This is a demo response - in a real implementation, this would connect to your /api/chat endpoint.",
        sender: "bot",
        timestamp: new Date()
      };
